      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className={`lg:w-1/2 mb-8 lg:mb-0 transition-all duration-700 ${
            ...
            <h1 className="text-4xl md:text-6xl font-bold hero-text leading-tight mb-6 mx-10">
              Vibe Your Brand.
              <br />
              <span className="gradient-text">Grow Your Reach.</span>
            </h1>
            <p className="text-xl text-advibe-dark/80 mb-8 leading-relaxed mx-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/plans">
                <Button variant="outline" className="px-8 py-4 -mx-10 rounded-full border-2 border-advibe-pink text-advibe-pink font-semibold text-lg hover:bg-advibe-pink hover:text-white transition-all">
                  View Plans
                </Button>
              </Link>
            </div>
