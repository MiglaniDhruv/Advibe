    ...
    <div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <section className="relative flex items-center justify-center py-20 bg-white overflow-hidden rounded-2xl shadow-lg">
              {/* Floating Icons */}
              ...
              <div className="text-center max-w-3xl">
                ...
                <p className="text-lg text-advibe-dark/80 mb-8 leading-relaxed">
                  Advibe is a dynamic digital marketing agency that transforms
                  brands through innovative strategies, creative content, and
                  data-driven campaigns. We believe every brand has a unique
                  vibe that deserves to be amplified.
                </p>
