...
export default function Plans() {
    ...
    const comparisonFeatures = [
        ...
        { feature: "Story Posts", silver: "8", gold: "12", diamond: "16" },
        {
            ...
            silver: "Instagram, Facebook",
            gold: "Instagram, Facebook, LinkedIn",
            diamond: "All Platforms",
        },
        {
            ...
            >
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
                    ...
                    <p className="text-xl text-gray-200 leading-relaxed">
                        Choose the perfect plan for your business needs. All
                        plans include dedicated account management and
                        ...
                        {plans.map((plan, index) => (
                            <div
                                ...
                                className={`bg-white rounded-3xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl ${
                                    plan.isPopular
                                        ? "border-2 border-advibe-pink relative "
                                        : ""
                                }`}
                                style={{
                            ...
                            >
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    <span className="text-advibe-dark/60 ">
                                        /month
                                    </span>
                                    <p className="text-advibe-dark/70 mt-4">
                                        {plan.description}
                                    </p>
                                </div>
                                    ...
                                    {plan.features.map(
                                        (feature, featureIndex) => (
                                            ...
                                            >
                                                ...
                                                <span className="text-advibe-dark/80">
                                                    {feature}
                                                </span>
                                            </div>
                                        )
                ...
                <div className="container mx-auto px-4">
                    <div
                        ...
                        className={`text-center mb-12 transition-all duration-700 ${
                            comparisonRef.isIntersecting
                                ? "opacity-100 translate-y-0"
                                : "opacity-0 translate-y-8"
                        }`}
                    >
                        <h2 className="text-3xl font-bold text-advibe-dark mb-4">
                            Compare Plans
                        </h2>
                        <p className="text-lg text-advibe-dark/70">
                            Detailed comparison of all our marketing packages
                        </p>
                    </div>
                        ...
                        <table className="w-full bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {comparisonFeatures.map((row, index) => (
                                    ...
                                    >
                                        <td className="px-6 py-4 font-medium text-advibe-dark">
                                            {row.feature}
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            {typeof row.silver === "boolean" ? (
                                              ...
                                              "Monthly Price" ? (
                                                <span className="font-bold text-advibe-pink">
                                                    {row.silver}
                                                </span>
                                            ) : (
                                                row.silver
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-lg text-advibe-dark/70 mb-8 max-w-2xl mx-auto">
                            ...
                            for your business needs and answer any questions you
                            may have.
                        </p>
