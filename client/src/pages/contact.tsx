            ...
            >
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
                    ...
                    <p className="text-xl text-gray-200 leading-relaxed">
                        Ready to take your marketing to the next level? Let’s
                        start a conversation about your goals and how we can
                        help achieve them.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-6">
                                Have a question or business inquiry? We’d love
                                to hear from you.
                            </p>
                            ...
                            <div className="flex gap-4 mt-6">
                                <a
                                    href="#"
                                    className="text-advibe-pink hover:underline"
                                >
                                    Twitter
                                </a>
                                <a
