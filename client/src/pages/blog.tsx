...
export default function Blog() {
    ...
    const blogPosts = [
        ...
        },
        {
            ...
            description:
                "Discover actionable SEO strategies that small businesses can implement to improve their search rankings and drive organic traffic.",
            date: "March 12, 2024",
            readTime: "6 min read",
        ...
        },
        {
            ...
            description:
                "Master the art of email automation with these proven workflows that nurture leads and drive conversions for your business.",
            date: "March 10, 2024",
            readTime: "5 min read",
        ...
        },
        {
            ...
            description:
                "Transform your content strategy with these actionable tips for creating engaging content that drives results and builds brand loyalty.",
            date: "March 8, 2024",
            readTime: "7 min read",
        ...
        },
        {
            ...
            description:
                "Take your Google Ads campaigns to the next level with advanced optimization techniques that seasoned marketers use to maximize ROI.",
            date: "March 5, 2024",
            readTime: "8 min read",
        ...
        },
        {
            ...
            description:
                "Learn how to create a distinctive brand identity that resonates with your target audience and sets you apart from competitors.",
            date: "March 3, 2024",
            readTime: "6 min read",
    ...
    const featuredPost = {
        ...
        description:
            "Discover the latest digital marketing trends that are shaping the industry and learn how to implement them in your marketing strategy for maximum impact and ROI.",
                            ...
                            <div className="md:flex">
                                ...
                                <div className="md:w-1/2 p-8">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <p className="font-semibold text-advibe-dark">
                                                {featuredPost.author}
                                            </p>
                        ...
                        {blogPosts.map((post, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        <div
                                            className={`${post.categoryColor} text-sm font-semibold mb-2`}
                                        >
                                            {post.category}
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-advibe-dark/60">
                                                {post.date}
                                            </span>
                                            <span className="text-sm text-advibe-dark/60">
                                                {post.readTime}
                                        ...
                                        <div className="mt-4">
                                            <Link href={`/blog/${post.id}`}>
                                                <button className="bg-gradient-to-r from-advibe-pink to-advibe-blue text-white px-5 py-2 rounded-full text-sm font-semibold hover:opacity-90 transition">
                                                    Read More →
                                                </button>
                                            </Link>
                                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div
                        ...
                        className={`max-w-2xl mx-auto text-center transition-all duration-700 ${
                            newsletterRef.isIntersecting
                                ? "opacity-100 translate-y-0"
                                : "opacity-0 translate-y-8"
                        }`}
                    >
                        <h3 className="text-3xl font-bold text-advibe-dark mb-4">
                            Stay Updated
                        </h3>
                        <p className="text-lg text-advibe-dark/70 mb-8">
                            Subscribe to our newsletter and never miss our
                            latest marketing insights, tips, and industry
                            updates.
                        </p>
