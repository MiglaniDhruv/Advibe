    ...
    <div>
      ...
      <section className="gradient-bg py-20 pt-32">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-advibe-dark mb-6">Our Services</h1>
            <p className="text-xl text-advibe-dark/80 leading-relaxed">
              Comprehensive digital marketing solutions designed to elevate your brand, engage your audience, and drive measurable results.
            </p>
          </div>
        </div>
      </section>
            ...
            return (
              <div
                ...
                className={`mb-20 transition-all duration-700 ${
                  serviceRef.isIntersecting ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
              >
                <div className={`grid lg:grid-cols-2 gap-12 items-center ${
                  ...
                  <div className={isEven ? "" : "lg:order-2"}>
                    <div className="flex items-center mb-6">
                      <div className="w-16 h-16 service-icon rounded-2xl flex items-center justify-center mr-4 text-white">
                        {service.icon}
                      </div>
                      <h2 className="text-3xl font-bold text-advibe-dark">{service.title}</h2>
                    </div>
                      ...
                      {service.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-center">
                          <Check className={`h-5 w-5 mr-3 ${
                            index % 2 === 0 ? "text-advibe-pink" : "text-advibe-blue"
                          }`} />
                          <span>{feature}</span>
                        </li>
                      ))}
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <h3 className="text-3xl font-bold text-advibe-dark mb-6">Ready to Elevate Your Marketing?</h3>
            <p className="text-lg text-advibe-dark/70 mb-8 max-w-2xl mx-auto">
              Let's discuss which services are right for your business and create a customized strategy for your success.
            </p>
